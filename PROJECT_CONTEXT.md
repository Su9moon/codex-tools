...
- Build and validate `skills/save-tokens` inside this repository before global installation.
...
- `skills/save-tokens`: workflow instructions and deterministic status helper.
